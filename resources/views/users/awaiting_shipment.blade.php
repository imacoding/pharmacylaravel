        ...
        @foreach($invoices as $invoice)
            ...
            <div class="card">
                <div class="card-head" id="heading{{$count}}">
                    <ul data-toggle="collapse" data-target="#collapse{{$count}}" class="collapsed" aria-expanded="true" aria-controls="collapse{{$count}}">
                        <li>
                            <p>Invoice</p>
                            {{ $invoice->invoice  }}
                        </li>
...
<div class="item-details-inner">
                    <figure>
                        @php
                            ...
                            $pre_img = ($pre_img && Storage::disk('PRESCRIPTION')->exists($email . '/thumbnails/' . $pre_img)) ? Storage::disk('PRESCRIPTION')->url($email . '/thumbnails/' . $pre_img) : Storage::disk('PRESCRIPTION')->url('no_pres_square.png')
                                        @endphp
