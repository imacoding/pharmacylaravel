                ...
                <div class="right-wrapper-innr">
                    ...
                    <div class="dashboard-contents">
                        <div class="mycart-contents">
                                ...
                                <div class="dropzone-outer">
                                    <div class="drop-zone">
                                        <div class="drop-zone__prompt ft14">
                                            <figure>
                                                <img class="mb-2" src="{{ url('/public/assets/images/upload-placeholder2.svg') }}" alt="">
                                            </figure>
                                            <p>
                                                You can use either JPEG, JPG or PNG images.<br>
                                                We will identify the medicines and process your order at the earliest.</p>
                                            <p class="d-none" id="pres-req">You are mandated to upload prescription to place the order.</p>
                                            <div class="btn-wrp">
                            ...
                            <div class="mycart-items-table">
                                <h2>My Cart</h2>
                                <div class="cart-items-innr">
...
@push('js')
<script src="{{url('assets/js/common/my_cart.js')}}" type="text/javascript"></script>
@endpush
