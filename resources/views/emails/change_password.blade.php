    ...
    <div style="width:570px;  margin:0 auto; ">
                ...
                <li style="list-style:none;  float:left;  margin-left: -38px; ">
                    <?php if (!empty(logo()) && Storage::disk('SYSTEM_IMAGE_URL')->exists(logo())) { ?>
                        <a href="<?php echo URL::to('/'); ?>"><img
                            src="<?php Storage::disk('SYSTEM_IMAGE_URL')->url(logo()); ?> "
        ...
        <div style="background:#fff; padding-left: 30px; padding-right: 30px; padding-top: 50px; padding-bottom: 75px; "
            ...
            <p>We would like to inform you that your  <?php echo \App\Models\Setting::param('site', 'app_name')['value']; ?>
                ...
                password while logging in to  <?php echo \App\Models\Setting::param('site', 'app_name')['value']; ?>.</p>

            <p>If you feel that your account password was changed by somebody else, please let us know about it
                immediately.</p>

            <p>If you have any questions, please send an email to <?php echo \App\Models\Setting::param('site', 'mail')['value']; ?>
                .</p>
