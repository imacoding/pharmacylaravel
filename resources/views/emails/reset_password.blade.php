	...
	<div style="width:570px;  margin:0 auto; ">
				...
				<?php if (!empty(logo()) && Storage::disk('SYSTEM_IMAGE_URL')->exists(logo())) { ?> 
					<li style="list-style:none;  float:left;  margin-left: -38px; ">
						<a href="<?php echo URL::to ('/'); ?>">
							<img src="<?php echo Storage::disk('SYSTEM_IMAGE_URL')->url(logo()); ?>" alt="<?php echo (\App\Models\Setting::param ('site' , 'app_name')['value']); ?>">
						</a>
					</li>
				<?php } ?>
		...
		<div style="background:#fff; padding-left: 30px; padding-right: 30px; padding-top: 50px; padding-bottom: 75px; "
			...
			<h2 style="font-family: 'Open Sans', sans-serif;  color:#272727; font-weight: 100; margin: 0;  font-size:14px; margin-bottom: 28px; ">
				...
				<!--            <p>We would like to inform you that your  --><?php //echo \App\Models\Setting::param('site', 'app_name')['value']; ?>
				<!--                password has been changed. Please make sure to use the new-->
				<!--                password while logging in to  -->
				<?php //echo \App\Models\Setting::param('site', 'app_name')['value']; ?><!--.</p>-->

				<p>Based on your request, if you wish to reset your password, Please click the following
					<a href="<?php echo url('/') . '?reset_code=' . $data['code'] . '&token=' . $data['token'] ?>">reset link </a>
				</p>

				<p style="text-align: center">or</p>

				<p> Enter the security code in your mobile app : <strong><?= $data['code']; ?></strong></p>
				...
				<p>If you have any questions, please send an email
					to <?php echo \App\Models\Setting::param ('site' , 'mail')['value']; ?>
					.</p>
